  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-24 sm:pt-32 pb-12 sm:pb-20">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-0 left-0 h-[150px] w-[250px] sm:h-[300px] sm:w-[500px] rounded-full bg-sky/25 blur-[60px] sm:blur-[80px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-teal/30 bg-teal/5 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm backdrop-blur-sm">
              <Sparkles className="h-3 w-3 sm:h-4 sm:w-4 text-teal" />
              <span className="text-muted-foreground">AI-Powered Property Matching</span>
              <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 text-teal" />
            </div>
          </motion.div>
