      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 sm:mt-20 grid gap-6 sm:gap-8 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-primary/15 to-teal/15 blur-3xl" />
            <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm">
              <div className="flex items-center gap-3 border-b border-border/50 bg-ivory/40 px-4 py-3">
          ...
          >
            <div className="rounded-2xl border border-border/50 bg-card/50 p-6 backdrop-blur-sm">
              <div className="mb-6 flex items-center justify-between">
                ...
                <span className="rounded-full bg-gold/15 px-3 py-1 text-sm text-gold border border-gold/30">
                  AI Ranked
                </span>
              </div>
              <div className="space-y-4">
                {matchedProperties.map((property, index) => (
                  <motion.div
                    ...
                    className="group relative overflow-hidden rounded-xl border border-border/50 bg-ivory/30 p-4 transition-all hover:border-gold/40 hover:bg-ivory/50"
                  >
                    <div className="flex flex-col sm:flex-row items-start justify-between gap-3 sm:gap-4">
                      <div className="flex gap-3 sm:gap-4">
                        <div className="flex h-10 w-10 sm:h-14 sm:w-14 items-center justify-center rounded-xl bg-teal/10">
                          <Building className="h-5 w-5 sm:h-6 sm:w-6 text-teal" />
                        </div>
                        <div>
                      ...
                      <div className="text-right">
                        ...
                        <div className="mt-1 flex items-center gap-1 text-sm">
                          ...
                          <span className="text-gold">{property.match}% match</span>
                        </div>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={item.label}
                  className="rounded-xl border border-teal/30 bg-card p-4 backdrop-blur-sm"
                >
                  <item.icon className="mb-3 h-5 w-5 text-teal" />
