  ...
  return (
    <section className="relative py-16 sm:py-24 lg:py-32" ref={ref}>
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-0 top-1/2 h-[400px] w-[400px] -translate-y-1/2 rounded-full bg-ivory/60 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block rounded-full border border-gold/40 bg-gold/10 px-4 py-1.5 text-sm text-gold">
            Testimonials
          </span>
        ...
        <div className="mt-10 sm:mt-16 grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl border border-border/50 bg-ivory/30 p-5 sm:p-8 backdrop-blur-sm transition-all hover:border-gold/40 hover:bg-ivory/50 hover:shadow-lg"
            >
